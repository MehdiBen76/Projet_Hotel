<template>
  <div class="team">
    ...
    <v-card-actions>
      <v-icon text class="ma-2">client</v-icon>
    ...
    <v-card-actions>
      ...
      <div class="overline">Projet Perso</div>
    </v-card-actions>
  </v-card>
      </v-flex>
       <v-flex
    ...
    <v-card-actions>
      ...
      <div class="overline">Prodect</div>
        ...
        <v-flex xs12 sm6 md4 lg3 v-for="client in team" :key="client.name">
              <v-card class="text-center ma-3">
                ...
                <v-card-text>
                  <div class="subheading">{{client.name}}</div>
                  <div class="grey--text">{{client.role}}</div>
                </v-card-text>
                <v-card-actions>
